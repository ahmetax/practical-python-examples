...
In this repository I will try to share some practical and tested python examples.
My examples are written and tested on an Ubuntu machine.
These examples will start from the beginner level.

I will use the text files in gutenberg_org in some of our examples. These
...
If you wish, you can share your own python examples also.
